...
Use the commands in [deployment](../../../docs/deployment.md), [Guide](../../../docs/quality-gates.md) and [API documentation](../../../docs/api-contracts.md). The [low-level design](../../../docs/LLD.md) defines ownership and persistence boundaries. Full artifact production through cloud activation remains in progress; the existing Airflow evidence DAG is not proof of that complete path.
