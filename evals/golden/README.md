...
`finance_workloads.yaml` contains earlier synthetic examples and a schema description. It is not the measured 32-case release suite and does not establish external finance-dataset coverage. [Evaluation methods](../../docs/evaluation.md) defines grading and [results](../../docs/results.md) records the failed gates.
